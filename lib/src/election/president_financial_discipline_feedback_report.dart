...
class PresidentFinancialDisciplineFeedbackIteration {
  const PresidentFinancialDisciplineFeedbackIteration({
...
class PresidentFinancialDisciplineFeedbackReport {
  PresidentFinancialDisciplineFeedbackReport({
    required this.m19Baseline,
    required this.finalReport,
    required Iterable<PresidentFinancialDisciplineFeedbackIteration> iterations,
    required this.maxIterations,
    required this.converged,
    required this.cycleDetected,
  }) : iterations = List.unmodifiable(iterations);

  final PresidentManagerElectionFeedbackReport m19Baseline;
  final PresidentReputationCareerReport finalReport;
  final List<PresidentFinancialDisciplineFeedbackIteration> iterations;
  final int maxIterations;
  final bool converged;
  final bool cycleDetected;

  PresidentReputationCareerReport get baselineReport => m19Baseline.finalReport;
  int get iterationCount => iterations.length;

  ManagerCareerReport get baselineManagerReport => m19Baseline.finalManagerReport;
  ...
  AdvancedTransferCareerReport get baselineAdvancedReport =>
      m19Baseline.finalAdvancedReport;
