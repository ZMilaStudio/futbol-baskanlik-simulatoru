...
class PresidentYouthOrientationFeedbackIteration {
  const PresidentYouthOrientationFeedbackIteration({
...
class PresidentYouthOrientationFeedbackReport {
  PresidentYouthOrientationFeedbackReport({
    required this.m23Baseline,
    required this.finalReport,
    required Iterable<PresidentYouthOrientationFeedbackIteration> iterations,
    required this.maxIterations,
    required this.converged,
    required this.cycleDetected,
  }) : iterations = List.unmodifiable(iterations);

  final PresidentRiskAppetiteFeedbackReport m23Baseline;
  final PresidentReputationCareerReport finalReport;
  final List<PresidentYouthOrientationFeedbackIteration> iterations;
  final int maxIterations;
  final bool converged;
  final bool cycleDetected;

  PresidentReputationCareerReport get baselineReport => m23Baseline.finalReport;
  int get iterationCount => iterations.length;

  ManagerCareerReport get baselineManagerReport => m23Baseline.finalManagerReport;
  ...
  AdvancedTransferCareerReport get baselineAdvancedReport =>
      m23Baseline.finalAdvancedReport;
