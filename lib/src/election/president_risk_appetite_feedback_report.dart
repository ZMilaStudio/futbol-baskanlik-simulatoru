...
class PresidentRiskAppetiteFeedbackIteration {
  const PresidentRiskAppetiteFeedbackIteration({
...
class PresidentRiskAppetiteFeedbackReport {
  PresidentRiskAppetiteFeedbackReport({
    required this.m21Baseline,
    required this.finalReport,
    required Iterable<PresidentRiskAppetiteFeedbackIteration> iterations,
    required this.maxIterations,
    required this.converged,
    required this.cycleDetected,
  }) : iterations = List.unmodifiable(iterations);

  final PresidentTransferAmbitionFeedbackReport m21Baseline;
  final PresidentReputationCareerReport finalReport;
  final List<PresidentRiskAppetiteFeedbackIteration> iterations;
  final int maxIterations;
  final bool converged;
  final bool cycleDetected;

  PresidentReputationCareerReport get baselineReport => m21Baseline.finalReport;
  int get iterationCount => iterations.length;

  ManagerCareerReport get baselineManagerReport => m21Baseline.finalManagerReport;
  ...
  AdvancedTransferCareerReport get baselineAdvancedReport =>
      m21Baseline.finalAdvancedReport;
